...
const TeacherDashboard = () => {
    ...
    const handleExportClass = async (classId, className, e) => {
        e.stopPropagation();
        setExportLoading(true);
        setExportMessage(`Mengekspor laporan kelas ${className}...`);
        try {
                            ...
                            {classes.map((cls) => (
                                <Card key={cls._id} className="group hover:border-primary-200 transition-all p-4">
                                    ...
                                    <div className="flex items-center justify-between pt-2 border-t border-slate-50 gap-2">
                                        ...
                                        <button
                                            onClick={(e) => handleExportClass(cls._id, cls.class_name, e)}
